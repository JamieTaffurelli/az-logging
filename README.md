...
| [azurerm_log_analytics_datasource_windows_event.events](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/log_analytics_datasource_windows_event) | resource |
| [azurerm_log_analytics_datasource_windows_performance_counter.perf](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/log_analytics_datasource_windows_performance_counter) | resource |
...
| [azurerm_resource_group_template_deployment.vmguesthealth](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/resource_group_template_deployment) | resource |
...
| <a name="input_data_collection_rule_template_path"></a> [data\_collection\_rule\_template\_path](#input\_data\_collection\_rule\_template\_path) | Path to data collection rule arm template | `string` | n/a | yes |
...
| <a name="output_data_collection_rule_id"></a> [data\_collection\_rule\_id](#output\_data\_collection\_rule\_id) | Resource ID of data collection rule |
